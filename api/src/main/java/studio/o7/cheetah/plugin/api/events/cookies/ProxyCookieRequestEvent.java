...
/**
 * {@link ProxyCookieRequestEvent} is fired when a cookie from a client is requested either by a proxy plugin or
 ...
 */
public final class ProxyCookieRequestEvent extends ProxyPlayerEvent {
    private static final HandlerList HANDLER_LIST = new HandlerList();

    public ProxyCookieRequestEvent(@NonNull ProxyPlayer player) {
        super(player);
    }
